...
export default async function DashboardPage({
  ...
  // Layout already validated auth. getCachedWorkspace() returns the cached workspace
  // from the layout (no extra DB call). We fetch connections in parallel with the role check.
